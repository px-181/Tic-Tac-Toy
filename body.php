		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<!-- <li class="active"><a data-toggle="tab" href="#tab1">Aeroplan</a></li>
									<li><a data-toggle="tab" href="#tab1">Truck</a></li>
									<li><a data-toggle="tab" href="#tab1">Teddy Bear</a></li>
									<li><a data-toggle="tab" href="#tab1">Car</a></li> -->
								</ul>
							</div>
						</div>
					</div>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 2 AND 5";
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 7 AND 10";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
