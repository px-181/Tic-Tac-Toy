		...
		<div id="top-header">
			<div class="container">
				<ul class="header-links pull-left">
					<li><a href="#"><i class="fa fa-phone"></i> +91 9969696969</a></li>
					<li><a href="#"><i class="fa fa-envelope-o"></i> tictactoy04@gmail.com</a></li>
		...
		<div class="container" id="get_category_home">
			<div id="responsive-nav">
				...
				<ul class="main-nav nav navbar-nav">
					...
					<li class="category" cid="1"><a href="store.php">abc</a></li>
					<li class="category" cid="2"><a href="store.php">xyz</a></li>
					<li class="category" cid="3"><a href="store.php">px</a></li>
