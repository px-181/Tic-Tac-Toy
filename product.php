					...
					<?php 
							...
							<div class="col-md-5">
								<div class="product-details">
									...
									<div>
										<h3 class="product-price">Rs.'.$row['product_price'].'<del class="product-old-price">Rs.1000.00 </del></h3>
        ...
        <div class="col-md-3 mainn">
            <div id="review-form">
                <form class="review-form" onsubmit="return false" id="review_form" required>
                    ...
                    <input name="product_id" value="<?php echo $product_id; ?>" type="hidden" required>
